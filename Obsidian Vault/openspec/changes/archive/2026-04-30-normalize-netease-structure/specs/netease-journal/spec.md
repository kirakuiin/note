...
- **THEN** it SHALL be placed at `Netease/0-Daily/2026/04/2026-04-30_�ձ�.md`

### Requirement: Daily report file naming

Daily report files SHALL follow the naming convention `YYYY-MM-DD_�ձ�.md`.

#### Scenario: Correct file name format

- **WHEN** a daily report for March 26, 2026 is saved
- **THEN** the file name SHALL be `2026-03-26_�ձ�.md`
